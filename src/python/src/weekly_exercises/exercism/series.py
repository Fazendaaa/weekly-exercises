...
# a ValueError if the series and/or length parameters input into the slice()
# function are empty or out of range. The tests will only pass if you both raise
...
def slices(
    ...
    return [series[index : index + slice] for index in range(len(series) - slice + 1)]
