...
#
# Output the encoded text in chunks that fill perfect rectangles (r X c), with c
# chunks of r length, separated by spaces. For phrases that are n characters
# short of the perfect rectangle, pad each of the last n chunks with a single
# trailing space.
#
